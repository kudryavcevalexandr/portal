...
JOBS = [
    # Пример под твою pairs-витрину:
    {
        "schema": "public",
        "table": "v_nomenclature_spec_pairs_v1",
        "index": "v_nomenclature_spec_pairs_v1",
        "id_col": "id",
        "fields": ["id", "name_tek", "name_tep_korr"],
        "order_by": "id",
        ...
        "mappings": {
            "id": {"type": "integer"},
            "name_tek": {"type": "text"},
            "name_tep_korr": {"type": "text"},
        }
    },

    # Добавляй дальше такие блоки под другие витрины/таблицы:
    # {
    #   "schema":"public",
    #   "table":"nomenclature_spec_all_os_v1",
    #   "index":"nomenclature_spec_all_os_v1",
    #   "id_col":"id",
    #   "fields":["id","item_name","type_mark"],
    #   "order_by":"id",
